              ...
              <el-tab-pane label="注意事项" name="fourth">
                ...
                <el-collapse v-model="activeNamess" @change="handleChange" accordion>
                  <el-collapse-item title="活动时长" name="1">
                    <div class="tes">
                      本线上打卡活动预计持续至
                      <strong>3月27日</strong>。由于正式开学时间的不确定性，
                      若在3月27日之前返校，则打卡活动将提前结束，我们可能会
                      <strong>适当调整</strong>达标性奖励中要求的积分，
                      以确保有30位同学可以拿到该奖励。
                    </div>
                  </el-collapse-item>
                  <el-collapse-item title="关于打卡" name="2">
                    <div class="tes">
                      <div>1.请在参与活动之前先添加“计软智学生会菌菌”为好友，否则部分打卡链接可能无法正常跳转；</div>
                      <div>2.部分浏览器（如Chrome等）上链接可能无法跳转，请切换浏览器；</div>
                      <div>3.每项任务一天最多打卡
                        <strong>一次</strong>，重复打卡不计入积分。
                      </div>
                    </div>
                  </el-collapse-item>
                  <el-collapse-item title="其它事项" name="3">
                    <div class="tes">
                      <div>1.任何恶意获取积分的行为（如利用平台漏洞篡改数据等），经查实后其所有积分无效，并保留进一步处理的权力；</div>
                      <div>2.如在使用平台中发现任何问题，或对规则存在疑问，您可以进入“我的”界面，点击
                        <strong>联系客服</strong>按钮；
                      </div>
											<div>3.参加活动前请先加入活动QQ群：<strong>1071823613</strong>。若平台出现问题，可能需要转为QQ群打卡。
											一切因没有加入QQ群而导致的积分损失由本人承担。</div>
                      <div>4.活动最终解释权归计软智学生会所有。</div>
                    </div>
                  </el-collapse-item>
                </el-collapse>
              </el-tab-pane>
